...
class DependencyProvider
{
    public function provide(Container $container): void
    {
        ...
        $container->set(SymfonyMailerManager::class, new SymfonyMailerManager($container->get(Mailer::class)));
        $container->set(CategoryRepository::class, new CategoryRepository($container->get(CategoriesMapper::class), $container::$entityManager));
        $container->set(ProductRepository::class, new ProductRepository($container->get(ProductsMapper::class), $container::$entityManager));
        $container->set(UserRepository::class, new UserRepository($container->get(UsersMapper::class), $container::$entityManager));
        $container->set(CategoryEntityManager::class, new CategoryEntityManager($container::$entityManager));
        $container->set(ProductEntityManager::class, new ProductEntityManager($container::$entityManager));
        $container->set(UserEntityManager::class, new UserEntityManager($container::$entityManager));
